...
NETWORK_RULES = {
    "Fidelis Medicaid":             {"All Products": "In Network"},
    "Fidelis Low-Cost":             {"All Products": "In Network"},
    "Fidelis Commercial":           {"All Products": "In Network"},
    "Fidelis Medicare":             {"All Products": "In Network"},
    "Anthem BCBS Medicare":         {"All Products": "In Network"},
    "Anthem BCBS Commercial":       {"All Products": "Evaluate"},
    "Anthem BCBS Medicaid (JLJ)":   {"All Products": "In Network"},
    "Anthem BCBS Low-Cost (JLJ)":   {"All Products": "In Network"},
    "Horizon BCBS":                 {"All Products": "In Network"},
    "BCBS TN":                      {"All Products": "In Network"},
    "BCBS FL":                      {"All Products": "In Network"},
    "BCBS WY":                      {"All Products": "In Network"},
    ...
    "Aetna Medicare":               {"All Products": "In Network"},
    "Aetna Commercial":             {"All Products": "In Network"},
    "Medicare A&B":                 {"All Products": "In Network"},
    "Medicaid":                     {"All Products": "In Network"},
    "NYSHIP":                       {"All Products": "In Network"},
    "Cigna":                        {"CGM": "Evaluate", "Pump/Supplies": "In Network"},
    "Humana":                       {"All Products": "In Network"},
    "Wellcare":                     {"All Products": "In Network"},
    "Midlands Choice":              {"All Products": "In Network"},
    "MagnaCare":                    {"All Products": "In Network"},
    "UMR":                          {"All Products": "In Network"},
    "Oregon Care":                  {"All Products": "In Network"},
}
